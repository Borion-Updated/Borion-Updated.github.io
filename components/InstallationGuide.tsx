  ...
  return (
    <div className="installation-guide bg-[#0A0A0A] rounded-lg p-8 mt-8 text-left border border-[#222222]">
      ...
      <ol className="list-decimal pl-8 space-y-4 text-[#E5E5E5]">
        ...
        <li>Use a dll loader like <a href="https://github.com/fligger/FateInjector" className="text-blue-400 hover:text-blue-300">fateinjector</a>, <a href="https://xealah.com/" className="text-blue-400 hover:text-blue-300">modinjector</a>, or the <a href="https://horion.download/" className="text-blue-400 hover:text-blue-300">Horion one</a> by right-clicking "inject"</li>
        <li>Enjoy!</li>
      </ol>
